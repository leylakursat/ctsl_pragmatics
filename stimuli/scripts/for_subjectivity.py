file = open("stim_subjectivity.txt", "a")
...
for x in range(len(items)):
    ...
    if adj1 in adjectives:
        print("already here: ", adj1)
    else:
        adjectives.append(adj1)
        stim1 =   "{" + "\n\t" + '"label": ' + '"' + label + '",' + "\n\t" + '"object": ' + '"' + object + '",' + "\n\t" + '"adj": ' + '"' + adj1 + '",' + "\n" + "}," + "\n"
        file.write(stim1)
    
    if adj2 in adjectives:
        print("already here: ", adj2)
    else:
        adjectives.append(adj2)
        stim2 =   "{" + "\n\t" + '"label": ' + '"' + label + '",' + "\n\t" + '"object": ' + '"' + object + '",' + "\n\t" + '"adj": ' + '"' + adj2 + '",' + "\n" + "}," + "\n"
        file.write(stim2)
